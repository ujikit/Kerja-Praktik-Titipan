...
<head>
	...
	<title>WEBSITE PENDAFTARAN PKL ELANG MAS KOMPUTER</title>
			...
			<div class="navbar-header">
				...
				<div class="navbar-collapse collapse">
					<ul class="nav navbar-nav pull-right mainNav">
						...
						<li class="c3"><a href="insertpendaftaran.php"><span class="fa fa-pencil"></span> Pendaftaran</a></li>
			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="grey-box-icon b4">  
						<h4>WELCOME</h4>
						<p>Selamat datang Di Website Pendaftaran PKL Elang Mas Komputer Yogyakarta </p>
						<p><a href="insertpendaftaran.php"><em>Daftarkan →</em></a></p>
					</div><!--grey box -->
				</div><!--/span3-->
			</div>
		</div>
